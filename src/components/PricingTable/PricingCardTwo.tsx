    ...
    return (
      <>
        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
          <div className="relative z-1 mb-10 overflow-hidden rounded-[10px] px-8 py-10 shadow-pricing dark:bg-zinc-900 sm:p-12 lg:px-6 lg:py-10 xl:p-[50px] glow-border">
