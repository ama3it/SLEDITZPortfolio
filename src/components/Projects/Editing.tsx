import t1 from "../../assets/projects/editing/1.jpg";
import t2 from "../../assets/projects/editing/2.jpg";
import t3 from "../../assets/projects/editing/3.jpg";
import t4 from "../../assets/projects/editing/4.jpg";
import t5 from "../../assets/projects/editing/5.jpg";
import t6 from "../../assets/projects/editing/6.jpg";
import t7 from "../../assets/projects/editing/7.jpg";
import t8 from "../../assets/projects/editing/8.jpg";
        ...
        <div className="lg:w-1/2 md:w-1/3 p-3 picture-item animate">
          <div className="group relative block rounded-xl duration-700 ease-in-out">
            <div className="relative overflow-hidden rounded-xl">
              <a href={t8} className="lightbox" title="">
                <img src={t8} className="rounded-xl" alt="" />
              </a>
            </div>
